...
public class DemoTurism {
        ...
        int[] prog1 = {7, 22}, prog2 = {12, 18},prog3={3,7},prog4={11,19},prog5={13,20};
        ...
        vecMuzeu.add(new Muzeu("Muzeul din Gradina Botanica", "Faleza Galati", prog2, 4.9f, pret4, "Stiinte ale naturii", 1930,988));
