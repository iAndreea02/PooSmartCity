...
public class DemoTurism {
    ...
    public static void main(String[] args) {
        ...
        vecMuzeu.add(new Muzeu("Muzeul din Gradina Botanica", "Faleza Galati", (new int[]{11, 17}), 4.9f, (new double[]{3.9, 5.2}), "Stiinte ale naturii", 1930, 988,(new double[]{10.5,4.5,6.7,3.4})));
        ...
        System.out.println(muzeu1+"\n\nPoze: "+muzeu1.showThatPrice("Poze"));
    }
